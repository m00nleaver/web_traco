			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
						...
						<div style="text-align: center;">
							<div> 찾으신 PW정보입니다.<br><br>ID: ${memberfind_pw}</div>
						
						</div>
						</c:if>	
					
						<c:if test="${empty memberfind_pw}">	
						<div style="text-align: center;">
						...
						<input type="button" value="뒤로가기" class="btn btn-primary" onclick="location.href='/traco/member/memberfind_pw.do';">
