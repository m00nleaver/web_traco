...
<body>
	...
	<main class="main">
		...
		<section class="content">
			...
			<form method="POST" action="/traco/admin/addflightok.do">
				<table class="table table-bordered addbox">
					...
					<tr>
						<td>상품여부</td>
						<td colspan="3">
							<span class="status1"><input type="radio" name="status" value="1" class="status">판매가능</span>
							<span class="status1"><input type="radio" name="status" value="2" class="status">판매종료</span>
					...
					<tr>
						<td>가격</td>
						<td colspan="5">
							<span class="price1">성인<input type="text" name="adult" class="price"></span>
							<span class="price1">아동<input type="text" name="kid" class="price"></span>
							<span class="price1">유아<input type="text" name="tod" class="price"></span>
						</td>
