		...
		<div class="box"><input type="button" class="btn btn-info" onclick="location.href='/traco/admin/adminmain.do';" value="메인메뉴"></div>
			...
			<table class="table table-bordered plist">
				...
				<tr>
					...
					<td> <!--seq 넘기기  -->
						<span class="glyphicon glyphicon-edit" onclick="location.href='/traco/admin/medit.do?seq=${pdto.pseq}';"></span> / 
						<span class="glyphicon glyphicon-trash" onclick="location.href='/traco/admin/mdel.do?seq=${pdto.pseq}';"></span>
					</td>
				</tr>
				</c:forEach>
			</table>
