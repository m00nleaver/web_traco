...
<body>
	...
	<main class="main">
		...
		<section class="content">
			...
			<form method="POST" action="/traco/admin/addpackageok.do">
					...
					<!-- 상품명 -->
						...
						<tr>
							...
							<td colspan="3">
								<input type="date" id="calendar1" min="2022-01-19" name="startday"> ~ <input type="date" id="calendar2" name="endday" max="2022-03-01" style="margin-right:30px;"> 일수 <input type="text" name="days" style="margin-left:20px; width:30px;">
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<input type="file" name="thumbs" style="margin-left:200px;">
							</td>
