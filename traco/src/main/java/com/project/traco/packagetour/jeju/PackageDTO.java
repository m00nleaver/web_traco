...
public class PackageDTO {
	...
	private String pkThumbName; //썸네일이름
	private String pkImageSeq; //이미지번호	
	private String pkAreaSeq; //지역번호
	private String pkAreaName; //지역이름
	private String pkPeriod; //일자
	private String pkStatus; //상품상태
	private String pkTagSeq; //해시태그 번호
	private String pkTagName; //해시태그명
	
	
	

	public String getPkAreaName() {
		return pkAreaName;
	}

	public void setPkAreaName(String pkAreaName) {
		this.pkAreaName = pkAreaName;
	}

	public String getPkThumbName() {
		return pkThumbName;
	}

	public void setPkThumbName(String pkThumbName) {
		this.pkThumbName = pkThumbName;
	}
